...
:END:
**** make-llm-openrouter-compatible
:PROPERTIES:
:ID:       5d6d59fa-cc1e-4e47-bf70-002d56c2e274
:END:

This helper function creates an LLM provider compatible with OpenRouter, using a given model string.
It wraps ~make-llm-openai-compatible~ with the correct API URL and your personal OpenRouter key, keeping
things DRY and making it easy to switch between supported models like Gemini or Qwen.
