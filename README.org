...
- *logid*: Configures and enables Logitech device customization daemon
...
- *Logitech Devices*: The installer automatically sets up =logid= with your =.config/logid.cfg= configuration. Adjust this file for your specific Logitech hardware if needed
